# Contributing to gocam_modular

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
gocam_modular. These guidelines are not strict rules.
...
The gocam_modular team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the gocam_modular technical leads
...
[issues]: https://github.com/monarch-initiative/gocam_modular/issues/
[pulls]: https://github.com/monarch-initiative/gocam_modular/pulls/

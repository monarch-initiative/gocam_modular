...
gh-add-topics:
  gh repo edit --add-topic "gocam_modular,monarchinitiative,linkml"
...
gh-invite-the-dragon:
  gh api repos/monarch-initiative/gocam_modular/collaborators/dragon-ai-agent -X PUT -f permission=push

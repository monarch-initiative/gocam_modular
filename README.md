...
| [Documentation](https://monarch-initiative.github.io/gocam_modular) |

Modular ingest of GOCAMs
...
Download the data for the gocam_modular transform:

```bash
poetry run gocam_modular download
```

To run the Koza transform for gocam_modular:

```bash
poetry run gocam_modular transform
```

To see available options:

```bash
poetry run gocam_modular download --help
# or
poetry run gocam_modular transform --help
```
